...
export const CHANNEL_STYLES: ChannelStyle[] = [
    ...
    },
    {
        ...
        description: 'Doodle-style glowing neon lines on pure black background — like neon sign strokes',
        descriptionVi: 'Nét vẽ doodle phát sáng neon trên nền đen — như ký hiệu đèn neon, dễ animate nhất quán',
        promptKeywords: 'neon glow doodle animation style, pure black background, simple doodle-style stick figure character drawn with glowing Neon Cobalt Violet luminous lines (like neon sign strokes NOT particles), clean simple doodle strokes that glow and emit colored light, objects drawn as simple doodle shapes with glowing neon outlines (scissors in Neon Magenta glow, money stack in Neon Gold and Teal glow), all lines are bold hand-drawn doodle strokes with neon glow effect radiating outward, whiteboard doodle animation style on black background with neon glowing ink instead of regular ink, clean luminous consistent strokes, smooth animation-friendly doodle motion',
        hasCharacters: true,
        suggestedCharCount: 1,
